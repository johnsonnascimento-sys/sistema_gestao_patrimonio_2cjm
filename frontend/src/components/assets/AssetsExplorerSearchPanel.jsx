      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-2">
        <div className="rounded-2xl border border-violet-200 bg-violet-50/60 px-4 py-3">
          ...
          <p className="mt-1 text-sm text-slate-700">
            Tombamento, etiqueta de 4 dígitos, câmera e material (SKU) resolvem a maior parte das
            consultas operacionais sem precisar abrir filtros extras.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">
            Abra filtros avançados quando
          </p>
          <p className="mt-1 text-sm text-slate-700">
            Você precisar investigar por endereço, responsável, status ou descrição e não tiver um
