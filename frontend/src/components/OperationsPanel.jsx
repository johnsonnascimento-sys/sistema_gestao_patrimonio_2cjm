...
const SECTION_META = {
  "admin-backup": {
    ...
    description: "Opera̵̤es de snapshot, backup manual e restore com confirmacao por senha ADMIN.",
  },
  "admin-health": {
  ...
  "admin-perfis": {
    ...
    description: "Gesṭo de perfis, papeis e reset de senha de primeiro acesso.",
  },
  "admin-locais": {
...
export default function OperationsPanel({ section = "admin-backup" }) {
  ...
  return (
    <section className="mt-6 space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <header>
        <h2 className="font-[Space_Grotesk] text-2xl font-semibold">Administra̤̣o do Painel</h2>
