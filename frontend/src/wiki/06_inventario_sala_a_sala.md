...
## Reset de Localiza��o F�sica (Pr�-Invent�rio Livre)

Na aba *Cadastrar bens por sala*, o Admin disp�e de dois recursos adicionais:

### Bot�o Resetar localiza��o

- Limpa o v�nculo de sala (`local_id`) de todos os bens � ou apenas da Unidade selecionada no dropdown.
- Exibe modal de confirma��o com aviso sobre o impacto.
- Ao confirmar, mostra quantos bens foram desvinculados e atualiza o gr�fico de progresso automaticamente.
- **Nenhum local cadastrado � apagado.** Apenas o v�nculo bens?sala � zerado.
- �til para recome�ar o mapeamento f�sico do zero, como um pr�-invent�rio sem as exig�ncias formais do invent�rio.

### Bot�o Ver bens por situa��o

- Abre um painel com duas abas:
  - **? Pendentes (sem sala)** � bens que ainda n�o t�m sala cadastrada
  - **? Conclu�dos (com sala)** � bens j� vinculados a um local
- O filtro de Unidade (dropdown acima) se aplica automaticamente � listagem.
- Pagina��o de 50 itens por p�gina, com navega��o Anterior/Pr�xima.
