...
Funcao no sistema: orientar uso do Wizard de classificação de inserviveis (Art. 141) com persistencia e auditoria.
...
- Aplicar a migration `database/013_documentos_avaliações_inserviveis.sql`.
